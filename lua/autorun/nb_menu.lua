...
hook.Add("PopulateToolMenu","NB_MENU",function()
	...
	spawnmenu.AddToolMenuOption("Options", "NB Settings", "NB_Settings", "#nb.menu.settings","","",function(pnl)
		if ( game.SinglePlayer() ) then
			...
			pnl:AddControl( "CheckBox", { Label = "#nb.menu.no_recoil", Command = "bot_no_recoil" } )
			...
			pnl:AddControl( "CheckBox", { Label = "#nb.menu.target.prop", Command = "bot_target_prop" } )
			pnl:AddControl( "CheckBox", { Label = "#nb.menu.ignore.unseen", Command = "bot_ignore_unseen" } )
			pnl:AddControl( "CheckBox", { Label = "#nb.menu.attack.friendly", Command = "bot_attack_friendly_npcs" } )
			pnl:ControlHelp( "" )
			...
			pnl:AddControl( "CheckBox", { Label = "#nb.menu.bot_chase", Command = "bot_chase_target" } )
			pnl:AddControl( "Slider", { Label = "#nb.menu.bot_chase_dist", Type = "Integer", Command = "bot_forwarddistance", Min = "0", Max = "1000" } )
			pnl:AddControl( "CheckBox", { Label = "#nb.menu.bot_dodge", Command = "bot_dodge_target" } )
